...
CONFIG = {
    ...
    'features': {
        'recipe_cols': [
            ...
            # ↓ table_speed 프로파일 (⚠️ 실제 컬럼명 확인 필요)
            'set_table_speed_0pct',  'set_table_speed_10pct', 'set_table_speed_20pct',
            'set_table_speed_30pct', 'set_table_speed_40pct', 'set_table_speed_50pct',
            'set_table_speed_60pct', 'set_table_speed_70pct', 'set_table_speed_80pct',
            'set_table_speed_90pct', 'set_table_speed_99pct', 'set_table_speed_100pct',
            'fdc_set_tension',
            'fdc_wait_time',
            'fdc_ingot_len',
        ],
...
def train_and_save(d, tag, cfg, out_dir):
    ...
    for key in ['set_frame_temp_60pct', 'set_table_speed_60pct', 'fdc_wait_time',
    ...
    meta = {
        ...
        'table_speed_cols': [c for c in RECIPE if 'set_table_speed' in c],
